...
const tasks: Task[] = [
  {
    ...
    // duration: 10,
    BaselineStartDate: new Date('2019-02-01t05:00:00.000Z'),
    BaselineEndDate: new Date('2019-07-25T12:00:00.000Z'),
    company: 'Roboplas',
    customProgress: 'Hazırlık',
    isRevision: false,
    customer: 'Aselsan',
    status: 'Tasarımda Olan Projeler',
    notes: 'Random Project Notes',
  },
  {
    id: 2,
    parentId: 1,
